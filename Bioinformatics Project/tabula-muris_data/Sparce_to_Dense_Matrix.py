# Converted Bash Sparce to Dense Matrix Concersion script using chatGPT
...
# import file references from the raw_data_path.py
...
genes = pd.read_csv("genes.tsv", sep="\t", header=None, names=["GeneID", "GeneName"])
genes.index += 1
...
matrix = pd.read_csv("matrix.mtx", sep=" ", skiprows=3, header=None, names=["Gene", "Barcode", "Value"])
